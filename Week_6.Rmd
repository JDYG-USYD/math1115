...
2. Given these options: -1, nearly -1, somewhat negative, 0, somewhat positive, nearly 1 and 1; what is the correlation between (with a short explanation):
    a. A person's age and their year of birth?
    - Should be 1 
    b. The price of a car and time?
    - Should be nearly -1
...
3. Given that the *family's income = husband's income + wife's income*, and using the same options as in Q2; what is the correlation between (with a short explanation):
    a. The wife's income and the family income?
    - Should be nearly 1
    b. The wife's income and the husband's income?
    - Should be 0
...
It is often dangerous to predict outside a model, especially in a timeseries dataset!
...
- Lab 1: `airquality`
- Lab 2: `AllFatalities.csv`
- Labs 3 & 4: `Titanic_train.csv`